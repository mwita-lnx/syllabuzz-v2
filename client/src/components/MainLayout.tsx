    ...
    <div className="flex flex-col min-h-screen" style={{ backgroundColor: colors.background }}>
      ...
      >
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          <div className="flex items-center gap-2 animate-slideIn cursor-pointer" onClick={() => navigate('/')}>
        ...
        {isMenuOpen && (
          ...
          >
            ...
            <Button 
              variant="ghost" 
              className="justify-start hover:bg-opacity-20 transition-colors" 
              onClick={() => {navigate('/units'); setIsMenuOpen(false);}}
            ...
            <Button 
              variant="ghost" 
              className="justify-start hover:bg-opacity-20 transition-colors" 
              onClick={() => {navigate('/notes'); setIsMenuOpen(false);}}
            ...
            <Button 
              variant="ghost" 
              className="justify-start hover:bg-opacity-20 transition-colors" 
              onClick={() => {navigate('/pastpapers'); setIsMenuOpen(false);}}
            ...
            <Button 
              variant="ghost" 
              className="justify-start hover:bg-opacity-20 transition-colors" 
              onClick={() => {navigate('/revision'); setIsMenuOpen(false);}}
